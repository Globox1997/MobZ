...
// Biome biome) {
// BlockPos blockPos = new BlockPos(x * 16, 0//
...
// // FloatingCastleGenerator.Piece., chunkGenerator, structureManager,
// blockPos,
// // children,
// // random);
// FloatingCastleGenerator.addPieces(structureManager, blockPos, blockRotation,
...
// // // // @Override
// // // // public boolean shouldStartAt(BiomeAccess biomeAccess,
// ChunkGenerator<?> chunkGenerator, Random random, int chunkX,
// // // // int chunkZ, Biome biome) {
// // // // ChunkPos chunkPos = this.getStart(chunkGenerator, random, chunkX,
// chunkZ, 0, 0);
// // // // return chunkX == chunkPos.x && chunkZ == chunkPos.z ?
// chunkGenerator.hasStructure(biome, this) : false;
// // // // }
...
// // // @Override
// // // public StructureStartFactory<DefaultFeatureConfig>
...
// public static class Start extends StructureStart {
// public Start(StructureFeature<?> feature, int chunkX, int chunkZ, BlockBox
// box, int references, long seed) {
...
// structureManager, int x, int z,
// Biome biome) {
// FloatingCastleGenerator.addPieces(chunkGenerator, structureManager, new
// BlockPos(x * 16, 60, z * 16), children,
// random);
// this.setBoundingBoxFromChildren();
// }
// }

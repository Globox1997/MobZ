...
public class ArmorItems {
    ...
    public static final Item life_leggings = register("life_leggings", new ArmorBase2(LIFEAPPARE, EquipmentSlot.LEGS));
    ...
    public static final Item speed_boots = register("speed_boots", new SpeedShoeBase(SPEEDAPPARE, EquipmentSlot.FEET));

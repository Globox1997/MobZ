...
public class SpeedShoeBase extends ArmorItem {
    ...
    public Multimap<String, EntityAttributeModifier> getModifiers(EquipmentSlot equipmentSlot_1) {
        ...
        if (equipmentSlot_1 == this.slot) {
           multimap_1.put(EntityAttributes.MOVEMENT_SPEED.getId(), new EntityAttributeModifier(MODIFIERS[equipmentSlot_1.getEntitySlotId()], "Speed", (int)this.b, EntityAttributeModifier.Operation.ADDITION));

...
//             Knight4Entity_1.setTamed(true);
//         }

//         return Knight4Entity_1;
//     }
...
//                 Knight4Entity Knight4Entity_1 = (Knight4Entity) livingEntity_1;
//                 if (Knight4Entity_1.isTamed() && Knight4Entity_1.getOwner() == livingEntity_2) {
//                     return false;
//                 }
//             }
...
//     static {
//         ALEX_HEALTH = DataTracker.registerData(Knight4Entity.class, TrackedDataHandlerRegistry.FLOAT);
//         BEGGING = DataTracker.registerData(Knight4Entity.class, TrackedDataHandlerRegistry.BOOLEAN);
//         COLLAR_COLOR = DataTracker.registerData(Knight4Entity.class, TrackedDataHandlerRegistry.INTEGER);
...
// import net.minecraft.entity.passive.Knight4Entity;
...
//     public Knight4Entity method_6717(PassiveEntity passiveEntity_1) {
//         Knight4Entity Knight4Entity_1 = (Knight4Entity) Entityinit.FRIEND.create(this.world);
//         UUID uUID_1 = this.getOwnerUuid();
//         if (uUID_1 != null) {
//             Knight4Entity_1.setOwnerUuid(uUID_1);
//             Knight4Entity_1.setTamed(true);

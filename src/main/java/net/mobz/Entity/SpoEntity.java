...
public class SpoEntity extends SpiderEntity {
    ...
    public static DefaultAttributeContainer.Builder createSpoEntityAttributes() {
        return HostileEntity.createHostileAttributes()
                .add(EntityAttributes.GENERIC_MAX_HEALTH,
                        Configinit.CONFIGZ.PurpleSpiderLife * Configinit.CONFIGZ.LifeMultiplicatorMob)
                .add(EntityAttributes.GENERIC_MOVEMENT_SPEED, 0.31D).add(EntityAttributes.GENERIC_ATTACK_DAMAGE,
                        Configinit.CONFIGZ.PurpleSpiderAttack * Configinit.CONFIGZ.DamageMultiplicatorMob);
    }
    ...
    public boolean canSpawn(WorldView view) {
        ...
        return view.intersectsEntities(this)
                ...
                && this.world.getBlockState(blockunderentity).allowsSpawning(view, blockunderentity, Entityinit.SPO)

...
public class SpiEye<T extends Entity, M extends SpiderEntityModel<T>> extends FeatureRenderer<T, M> {
   private static final Identifier SKIN = new Identifier("mobz:textures/entity/spieyes.png");

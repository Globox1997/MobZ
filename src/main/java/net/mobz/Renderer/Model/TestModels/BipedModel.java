...
public class BipedModel<T extends LivingEntity> extends EntityModel<T> implements ModelWithArms, ModelWithHead {
   public Cuboid head;
   ...
   public BipedModel(float float_1) {
      this(float_1, 0.0F, 64, 32);
   }

   public BipedModel(float float_1, float float_2, int int_1, int int_2) {
   ...
   public void method_17088(T livingEntity_1, float float_1, float float_2, float float_3, float float_4, float float_5,
         float float_6) {
   ...
   public void method_17087(T livingEntity_1, float float_1, float float_2, float float_3, float float_4, float float_5,
         float float_6) {
      ...
      if (this.rightArmPose == BipedModel.ArmPose.BOW_AND_ARROW) {
         ...
         this.leftArm.pitch = -1.5707964F + this.head.pitch;
            ...
            && this.rightArmPose != BipedModel.ArmPose.THROW_SPEAR && this.rightArmPose != BipedModel.ArmPose.BLOCK) {
      ...
      if (this.rightArmPose == BipedModel.ArmPose.CROSSBOW_HOLD && this.handSwingProgress <= 0.0F) {
      ...
      if (this.field_3396 > 0.0F) {
         ...
         if (float_14 < 14.0F) {
            ...
            this.leftArm.roll = this.method_2804(this.leftArm.roll,
                  3.1415927F + 1.8707964F * this.method_2807(float_14) / this.method_2807(14.0F), this.field_3396);
            this.rightArm.roll = MathHelper.lerp(float_15, this.rightArm.roll,
                  3.1415927F - 1.8707964F * this.method_2807(float_14) / this.method_2807(14.0F));
            ...
            this.leftArm.pitch = this.method_2804(this.leftArm.pitch, 1.5707964F - 1.5707964F * float_17,
                  this.field_3396);
         ...
         this.leftLeg.pitch = MathHelper.lerp(this.field_3396, this.leftLeg.pitch,
               0.3F * MathHelper.cos(float_1 * 0.33333334F + 3.1415927F));
         this.rightLeg.pitch = MathHelper.lerp(this.field_3396, this.rightLeg.pitch,
               0.3F * MathHelper.cos(float_1 * 0.33333334F));
      }
   ...
   public void setAttributes(BipedModel<T> BipedModel_1) {
      super.copyStateTo(BipedModel_1);
      BipedModel_1.leftArmPose = this.leftArmPose;
      BipedModel_1.rightArmPose = this.rightArmPose;
      BipedModel_1.isSneaking = this.isSneaking;
   }
   ...
   public static enum ArmPose {
      EMPTY, ITEM, BLOCK, BOW_AND_ARROW, THROW_SPEAR, CROSSBOW_CHARGE, CROSSBOW_HOLD;
   }
}

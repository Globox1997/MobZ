...
public abstract class AbstractModel<T extends HostileEntity> extends BipedModel<T> {
    protected AbstractModel(float float_1, float float_2, int int_1, int int_2) {
        super(float_1, float_2, int_1, int_2);
    }

    public void method_17791(T hostileEntity_1, float float_1, float float_2, float float_3, float float_4,

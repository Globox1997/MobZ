...
public class Entityinit {
    ...
    public static void init() {
        ...
        Registry.register(Registry.ITEM, new Identifier("mobz", "spawn_tank"),
                new SpawnEggItem(TANK, 5055902, 2507798, new Item.Settings().maxCount(64).group(ItemGroup.MISC)));
        Registry.register(Registry.ITEM, new Identifier("mobz", "spawn_fast"),
                new SpawnEggItem(FAST, 6109639, 2968097, new Item.Settings().maxCount(64).group(ItemGroup.MISC)));
        Registry.register(Registry.ITEM, new Identifier("mobz", "spawn_test"),
                new SpawnEggItem(TEST, 2039583, 9109643, new Item.Settings().maxCount(64).group(ItemGroup.MISC)));
        Registry.register(Registry.ITEM, new Identifier("mobz", "spawn_armored"),
                new SpawnEggItem(ARMORED, 1397590, 3165729, new Item.Settings().maxCount(64).group(ItemGroup.MISC)));
        Registry.register(Registry.ITEM, new Identifier("mobz", "spawn_boss"),
                new SpawnEggItem(BOSS, 1181988, 3560490, new Item.Settings().maxCount(64).group(ItemGroup.MISC)));
        Registry.register(Registry.ITEM, new Identifier("mobz", "spawn_creep"),
                new SpawnEggItem(CREEP, 4897722, 0, new Item.Settings().maxCount(64).group(ItemGroup.MISC)));
        Registry.register(Registry.ITEM, new Identifier("mobz", "spawn_crip"),
                new SpawnEggItem(CRIP, 10250793, 0, new Item.Settings().maxCount(64).group(ItemGroup.MISC)));
        Registry.register(Registry.ITEM, new Identifier("mobz", "spawn_ender"),
                new SpawnEggItem(ENDER, 7884109, 2167558, new Item.Settings().maxCount(64).group(ItemGroup.MISC)));
        Registry.register(Registry.ITEM, new Identifier("mobz", "spawn_enderzombie"),
                new SpawnEggItem(ENDERZOMBIE, 656405, 3876927, new Item.Settings().maxCount(64).group(ItemGroup.MISC)));
        Registry.register(Registry.ITEM, new Identifier("mobz", "spawn_spi"),
                new SpawnEggItem(SPI, 3291714, 960680, new Item.Settings().maxCount(64).group(ItemGroup.MISC)));
        Registry.register(Registry.ITEM, new Identifier("mobz", "spawn_spo"),
                new SpawnEggItem(SPO, 4864065, 10817192, new Item.Settings().maxCount(64).group(ItemGroup.MISC)));
        Registry.register(Registry.ITEM, new Identifier("mobz", "spawn_pig"),
                new SpawnEggItem(PIG, 9856837, 3169838, new Item.Settings().maxCount(64).group(ItemGroup.MISC)));
        Registry.register(Registry.ITEM, new Identifier("mobz", "spawn_lavagolem"),
                new SpawnEggItem(LAVAGOLEM, 7806478, 16652145, new Item.Settings().maxCount(64).group(ItemGroup.MISC)));
        Registry.register(Registry.ITEM, new Identifier("mobz", "spawn_icegolem"),
                new SpawnEggItem(ICEGOLEM, 7499112, 1572516, new Item.Settings().maxCount(64).group(ItemGroup.MISC)));
        Registry.register(Registry.ITEM, new Identifier("mobz", "spawn_skeli1"),
                new SpawnEggItem(SKELI1, 5066061, 3932162, new Item.Settings().maxCount(64).group(ItemGroup.MISC)));
        Registry.register(Registry.ITEM, new Identifier("mobz", "spawn_skeli2"),
                new SpawnEggItem(SKELI2, 5263682, 11534, new Item.Settings().maxCount(64).group(ItemGroup.MISC)));
        Registry.register(Registry.ITEM, new Identifier("mobz", "spawn_skeli3"),
                new SpawnEggItem(SKELI3, 4801614, 5121582, new Item.Settings().maxCount(64).group(ItemGroup.MISC)));
        Registry.register(Registry.ITEM, new Identifier("mobz", "spawn_archer"), new SpawnEggItem(ARCHERENTITY, 2123875,
                1117987, new Item.Settings().maxCount(64).group(ItemGroup.MISC)));
        Registry.register(Registry.ITEM, new Identifier("mobz", "spawn_archer2"), new SpawnEggItem(ARCHER2ENTITY,
                2123813, 1117987, new Item.Settings().maxCount(64).group(ItemGroup.MISC)));
        Registry.register(Registry.ITEM, new Identifier("mobz", "spawn_bigboss"), new SpawnEggItem(BIGBOSSENTITY,
                667182, 984607, new Item.Settings().maxCount(64).group(ItemGroup.MISC)));
        Registry.register(Registry.ITEM, new Identifier("mobz", "spawn_fulliron"), new SpawnEggItem(FULLIRONENTITY,
                888205, 4800672, new Item.Settings().maxCount(64).group(ItemGroup.MISC)));
        Registry.register(Registry.ITEM, new Identifier("mobz", "spawn_knight"), new SpawnEggItem(KNIGHTENTITY, 7165479,
                7678221, new Item.Settings().maxCount(64).group(ItemGroup.MISC)));
        Registry.register(Registry.ITEM, new Identifier("mobz", "spawn_knight2"), new SpawnEggItem(KNIGHT2ENTITY,
                8881541, 4797474, new Item.Settings().maxCount(64).group(ItemGroup.MISC)));
        Registry.register(Registry.ITEM, new Identifier("mobz", "spawn_mage"), new SpawnEggItem(MAGEENTITY, 5128776,
                12342593, new Item.Settings().maxCount(64).group(ItemGroup.MISC)));
        Registry.register(Registry.ITEM, new Identifier("mobz", "spawn_mage2"), new SpawnEggItem(MAGE2ENTITY, 4211261,
                2375449, new Item.Settings().maxCount(64).group(ItemGroup.MISC)));
        Registry.register(Registry.ITEM, new Identifier("mobz", "spawn_smallzombie"), new SpawnEggItem(SMALLZOMBIE,
                3222535, 1116191, new Item.Settings().maxCount(64).group(ItemGroup.MISC)));
        Registry.register(Registry.ITEM, new Identifier("mobz", "spawn_frost"),
                new SpawnEggItem(FROSTENTITY, 8709375, 86111, new Item.Settings().maxCount(64).group(ItemGroup.MISC)));
        Registry.register(Registry.ITEM, new Identifier("mobz", "spawn_dog"),
                new SpawnEggItem(DOG, 7734790, 12550144, new Item.Settings().maxCount(64).group(ItemGroup.MISC)));
        Registry.register(Registry.ITEM, new Identifier("mobz", "spawn_stonegolem"), new SpawnEggItem(STONEGOLEM,
                10197915, 6654258, new Item.Settings().maxCount(64).group(ItemGroup.MISC)));
        Registry.register(Registry.ITEM, new Identifier("mobz", "spawn_illusioner"),
                new SpawnEggItem(ILLUSIONER, 6376248, 4344910, new Item.Settings().maxCount(64).group(ItemGroup.MISC)));
        Registry.register(Registry.ITEM, new Identifier("mobz", "spawn_dwarf"), new SpawnEggItem(DWARFENTITY, 8551531,
                6755862, new Item.Settings().maxCount(64).group(ItemGroup.MISC)));
        Registry.register(Registry.ITEM, new Identifier("mobz", "spawn_spismall"),
                new SpawnEggItem(SPISMALL, 3806513, 146458, new Item.Settings().maxCount(64).group(ItemGroup.MISC)));
        Registry.register(Registry.ITEM, new Identifier("mobz", "spawn_blackbear"),
                new SpawnEggItem(BLACKBEAR, 657934, 2960685, new Item.Settings().maxCount(64).group(ItemGroup.MISC)));
        Registry.register(Registry.ITEM, new Identifier("mobz", "spawn_brownbear"),
                new SpawnEggItem(BROWNBEAR, 2169097, 4403731, new Item.Settings().maxCount(64).group(ItemGroup.MISC)));
        Registry.register(Registry.ITEM, new Identifier("mobz", "spawn_gchicken"),
                new SpawnEggItem(GCHICKEN, 13027014, 15315221, new Item.Settings().maxCount(64).group(ItemGroup.MISC)));
        Registry.register(Registry.ITEM, new Identifier("mobz", "spawn_boar"),
                new SpawnEggItem(BOAR, 3211264, 9984303, new Item.Settings().maxCount(64).group(ItemGroup.MISC)));
        Registry.register(Registry.ITEM, new Identifier("mobz", "spawn_boar2"),
                new SpawnEggItem(BOAR2, 14601929, 2962756, new Item.Settings().maxCount(64).group(ItemGroup.MISC)));
        Registry.register(Registry.ITEM, new Identifier("mobz", "spawn_boar3"),
                new SpawnEggItem(BOAR3, 13284514, 2890508, new Item.Settings().maxCount(64).group(ItemGroup.MISC)));
        Registry.register(Registry.ITEM, new Identifier("mobz", "spawn_friend"),
                new SpawnEggItem(FRIEND, 11123336, 15043903, new Item.Settings().maxCount(64).group(ItemGroup.MISC)));
        Registry.register(Registry.ITEM, new Identifier("mobz", "spawn_knight3"), new SpawnEggItem(KNIGHT3ENTITY,
                2303296, 11497623, new Item.Settings().maxCount(64).group(ItemGroup.MISC)));
        Registry.register(Registry.ITEM, new Identifier("mobz", "spawn_knight4"), new SpawnEggItem(KNIGHT4ENTITY,
                2120818, 12160610, new Item.Settings().maxCount(64).group(ItemGroup.MISC)));
        Registry.register(Registry.ITEM, new Identifier("mobz", "spawn_knight5"), new SpawnEggItem(KNIGHT5ENTITY,
                1118487, 5000017, new Item.Settings().maxCount(64).group(ItemGroup.MISC)));
        Registry.register(Registry.ITEM, new Identifier("mobz", "spawn_with"),
                new SpawnEggItem(WITHENTITY, 1841947, 8157561, new Item.Settings().maxCount(64).group(ItemGroup.MISC)));
        Registry.register(Registry.ITEM, new Identifier("mobz", "spawn_skeli4"),
                new SpawnEggItem(SKELI4, 4079166, 11776947, new Item.Settings().maxCount(64).group(ItemGroup.MISC)));
        Registry.register(Registry.ITEM, new Identifier("mobz", "spawn_slimo"),
                new SpawnEggItem(SLIMO, 7121986, 7951674, new Item.Settings().maxCount(64).group(ItemGroup.MISC)));
        Registry.register(Registry.ITEM, new Identifier("mobz", "spawn_withender"),
                new SpawnEggItem(WITHENDER, 11797152, 1710618, new Item.Settings().maxCount(64).group(ItemGroup.MISC)));

...
public class Iteminit {
        ...
        public static final MedivealDisc2 MEDIVEAL_DISC2 = new MedivealDisc2(0, Soundinit.MEDIVEALSOUND2EVENT,
                        new Item.Settings().maxCount(1));
        public static final Shield SHIELD = new Shield(new Item.Settings().maxDamage(589));
        ...
        public static final Knight2entityhead KNIGHT2ENTITYHEAD = new Knight2entityhead(
                        new Item.Settings().maxCount(1));
        public static final Knight5entityhead KNIGHT5ENTITYHEAD = new Knight5entityhead(
                        new Item.Settings().maxCount(1));
        ...
        public static final Babyravagerhead BABYRAVAGERHEAD = new Babyravagerhead(new Item.Settings().maxCount(1));
        public static final Islandkinghead ISLANDKINGHEAD = new Islandkinghead(new Item.Settings().maxCount(1));
        public static final Islandknightspecialhead ISLANDKNIGHTSPECIALHEAD = new Islandknightspecialhead(
                        new Item.Settings().maxCount(1));
        public static final Islandknightspecial2head ISLANDKNIGHTSPECIAL2HEAD = new Islandknightspecial2head(
                        new Item.Settings().maxCount(1));
